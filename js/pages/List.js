...
export default {
        ...
        <main v-else class="page-list">
            ...
            <div class="meta-container">
                <div class="meta">
                    ...
                    <h3>PHTILL Criteria</h3>
                    <p>Physically, Humanly, & Theoretically Impossible.</p>
                </div>
            </div>
        </main>
    `,
    ...
    computed: {
        ...
        video() {
            // Updated to look directly at verification/showcase without score dependencies
            return embed(this.level.ytcode);
        },
    },
    async mounted() {
